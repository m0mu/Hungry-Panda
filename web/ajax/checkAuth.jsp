    ...
    try {
        ...
        if (idToken != null) {
            ...
            if (emailVerified) {
                ...
                session.setAttribute("sessionCustomer", email);
                session.setAttribute("sessionCustomerName", name);
                session.setAttribute("sessionCustomerMobile", email);
